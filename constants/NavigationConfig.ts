    ...
    subsections: [
      {
        ...
        icon: 'user-shield',
        type: 'single',
        path: '/TourismCMS/(admin)/staff-management',
        permissions: ['tourism_admin'],
      },
      {
        id: 'business-owners',
      ...
      },
      {
        ...
        icon: 'user',
        type: 'single',
        path: '/TourismCMS/(admin)/tourist-accounts',
        permissions: ['tourism_admin'],
      },
    ],
  },
    ...
    subsections: [
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            icon: 'bed',
            type: 'single',
            path: '/TourismCMS/(admin)/business-listings/accommodations',
            permissions: ['tourism_admin', 'business_listing_manager'],
          },
          {
            id: 'shops-services',
            ...
            icon: 'shopping-bag',
            type: 'single',
            path: '/TourismCMS/(admin)/business-listings/shops-services',
            permissions: ['tourism_admin', 'business_listing_manager'],
          },
          {
            ...
            icon: 'star',
            type: 'single',
            path: '/TourismCMS/(admin)/business-listings/featured',
            permissions: ['tourism_admin', 'business_listing_manager'],
          },
        ],
      },
        ...
        subsections: [
          {
            ...
            icon: 'clock',
            type: 'single',
            path: '/TourismCMS/(admin)/business-registrations/pending',
            permissions: ['tourism_admin', 'business_registration_manager'],
            badge: { count: 8, type: 'warning' },
          },
          {
            ...
            icon: 'history',
            type: 'single',
            path: '/TourismCMS/(admin)/business-registrations/history',
            permissions: ['tourism_admin', 'business_registration_manager'],
          },
          {
            ...
            icon: 'x-circle',
            type: 'single',
            path: '/TourismCMS/(admin)/business-registrations/rejected',
            permissions: ['tourism_admin', 'business_registration_manager'],
          },
        ],
      },
      {
        ...
        icon: 'trending-up',
        type: 'single',
        path: '/TourismCMS/(admin)/business-analytics',
        permissions: ['tourism_admin', 'business_listing_manager'],
      },
    ],
  },
    ...
    subsections: [
      {
        ...
        icon: 'tag',
        type: 'single',
        path: '/TourismCMS/(admin)/categories/business',
        permissions: ['tourism_admin', 'business_listing_manager'],
      },
      {
        ...
        icon: 'compass',
        type: 'single',
        path: '/TourismCMS/(admin)/categories/tourism',
        permissions: ['tourism_admin', 'tourism_content_manager'],
      },
    ],
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        icon: 'dollar-sign',
        type: 'single',
        path: '/TourismCMS/(admin)/financial-overview',
        permissions: ['tourism_admin'],
      },
    ],
  },
  {
    ...
    subsections: [
      ...
      },
      {
        ...
        icon: 'trending-up',
        type: 'single',
        path: '/TourismCMS/(admin)/analytics/business',
        permissions: ['tourism_admin', 'business_listing_manager'],
      },
      {
        ...
        icon: 'map',
        type: 'single',
        path: '/TourismCMS/(admin)/analytics/tourism',
        permissions: ['tourism_admin', 'tourism_content_manager'],
      },
      {
        ...
        icon: 'user-plus',
        type: 'single',
        path: '/TourismCMS/(admin)/analytics/registrations',
        permissions: ['tourism_admin', 'business_registration_manager'],
      },
    ],
  },
