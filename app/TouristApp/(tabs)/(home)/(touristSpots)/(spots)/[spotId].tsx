              ...
              {activeTab === "details" && (
                <View style={styles.detailsTab}>
                  ...
                  <SpotMoreImages
                    ...
                    onSeeAll={() => router.push({ pathname: "/TouristApp/(tabs)/(home)/(touristSpots)/(spots)/AllImages", params: { images: spot.additionalImages.join(",") } })}
                  />
                  <SpotMapSection mapLocation={spot.mapLocation} address={spot.location} iconColor={Colors[colorScheme].icon} />
                </View>
              )}
              {activeTab === "reviews" && (
                <SpotReviewsSection
