...
const EventDetails = () => {
        ...
        <View style={styles.header}>
            ...
            <View style={styles.headerContent}>
                ...
                <View style={styles.ratingContainer}>
                    ...
                    <ThemedText style={styles.rating}>{eventReviews?.averageRating || 0}</ThemedText>
                    <ThemedText style={styles.ratingCount}>({eventReviews?.totalReviews || 0})</ThemedText>
                </View>
            </View>
        </View>
    );
            ...
            <View style={styles.detailsContainer}>
                <View style={styles.reviewsSummary}>
                    <View style={styles.overallRating}>
                        <ThemedText style={styles.averageRating}>{eventReviews.averageRating}</ThemedText>
    ...
    const renderDetails = () => (
        <View style={styles.detailsContainer}>
            ...
            <View style={styles.section}>
                <ThemedText style={styles.sectionTitle}>ENTRANCE /ADMISSION FEE:</ThemedText>
            ...
            <View style={styles.section}>
                <View style={styles.sectionTitleContainer}>
                    ...
                    <Pressable onPress={() => router.push(`/TouristApp/(tabs)/(home)/(events)/images?id=${event.id}`)}>
                        <ThemedText style={styles.seeAllButton}>See All</ThemedText>
                    </Pressable>
                </View>
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.imageGallery}>
                    {[event.image.src, event.image.src, event.image.src].map((img, index) => (
                        <Pressable 
                            key={index} 
                            onPress={() => router.push(`/TouristApp/(tabs)/(home)/(events)/images?id=${event.id}`)}
