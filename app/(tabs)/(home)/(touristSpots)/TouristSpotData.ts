...
export const touristSpotsData: { [key: string]: TouristSpot } = {
  ...
  4: {
    ...
    additionalImages: [],
    location: "Panicuason, Naga City, Camarines Sur",
    mapLocation: { latitude: 13.663670840210843, longitude: 123.33689878662024 },
    contact: "DENR Region V",
  ...
  5: {
    ...
    mapLocation: { latitude: 13.634427116867132, longitude: 123.19541593970112 },
  ...
  6: {
    ...
    additionalImages: [],
    location: "Panicuason, Naga City, Camarines Sur",
    mapLocation: { latitude: 13.672114857194526, longitude: 123.32050396629431 },
  ...
  7: {
    ...
    category: "urban",
    description: "A major shopping mall in Naga City offering a variety of retail, dining, and entertainment options.",
    image: "https://rlcommercialreit.com.ph/sites/default/files/portfolio/Cybergate-Naga.png",
    additionalImages: [],
    location: "Roxas Avenue cor. Almeda Highway, Brgy. Triangulo, Naga City, Camarines Sur",
    mapLocation: { latitude: 13.615618815288265, longitude: 123.19336149328089 }, // Approximate coordinates
  ...
  8: {
    ...
    name: "Avenue Square",
    category: "urban",
    description: "A popular commercial complex in Naga City known for its restaurants, bars, and shops.",
    image: "https://www.theavenueplazahotel.com/assets/others/avenue_square-e2e2a3c54ed22fb17c1eed075d694ed9.jpg",
    additionalImages: [],
    location: "Magsaysay Avenue, Naga City, Camarines Sur",
    mapLocation: { latitude: 13.632303298842043, longitude: 123.19624412698813 }, // Approximate coordinates
    contact: "N/A",
    openingHours: "Varies",
  ...
  9: {
    ...
    category: "museums",
    description: "A museum dedicated to the life and legacy of the late Jesse M. Robredo, former Mayor of Naga City and DILG Secretary.",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4mBM9FhkaRsDdz2T_YigB3VEZjMu92asFrQ&s",
    additionalImages: [],
    location: "Naga Civic Center, Taal Ave cor. J.Miranda Ave, Brgy. Concepcion Pequeña, Naga City, Camarines Sur",
    mapLocation: { latitude: 13.628807741401566, longitude: 123.19728423745774 }, // Approximate coordinates
  ...
  10: {
    ...
    category: "historical",
    description: "One of the oldest churches in the Bicol Region, known for its Spanish-era architecture.",
    image: "https://i0.wp.com/nagayon.com/wp-content/uploads/2024/05/San-Francisco-Exterior_1-scaled.jpg?fit=1200%2C900&ssl=1",
    additionalImages: [],
    location: "Peñafrancia Street, Naga City, Camarines Sur",
    mapLocation: { latitude: 13.624514180255026, longitude: 123.18629871447476}, // Approximate coordinates
    contact: "N/A",
    openingHours: "Varies",
    admissionFee: "Free",
  },
  11: {
    ...
    category: "historical",
    description: "A historical plaza in downtown Naga City, commemorating fifteen martyrs of the Bicol Region.",
    image: "https://upload.wikimedia.org/wikipedia/commons/c/c5/IJVSanFranciscoChurch1.jpg", 
    additionalImages: [],
    location: "General Luna Street, Naga City, Camarines Sur",
    mapLocation: { latitude: 13.624569899153629, longitude: 123.18590977079522 }, // Approximate coordinates
    contact: "N/A",
    openingHours: "Open 24 hours",
    admissionFee: "Free",
  },
  12: {
    ...
    category: "urban",
    description: "The main thoroughfare in Naga City, known for its vibrant nightlife, restaurants, and commercial establishments.",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnni0TyM7KDBBYLiW9sDH8syVOl5Mb1y1WpA&s",
    additionalImages: [],
    location: "Magsaysay Avenue, Naga City, Camarines Sur",
    mapLocation: { latitude: 13.628833328622463, longitude: 123.19927649512846 }, // Approximate coordinates (center of the avenue)
    contact: "N/A",
    openingHours: "Varies",
    admissionFee: "Free (establishment-dependent)",
  },
